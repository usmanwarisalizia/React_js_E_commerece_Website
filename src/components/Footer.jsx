        ...
        <div>
            <div className="flex flex-col sm:grid grid-cols-[3fr_1fr_1fr] gap-14 my-10 mt-40 text-sm">
                ...
                <div>
                    ...
                    <ul className="flex flex-col gap-1 text-gray-600">
                        <li>+92-323-672-4894</li>
                        <li>usmanwaris1999@gmail.com</li>
            ...
            <div>
                <hr />
                <p className="py-5 text-sm text-center text-gray-600">Copyright 2024@ usmanwaris.dev - All Right Reserved.</p>
            </div>
        </div>
    )
};
